...
describe('UsagePage toolbar styles', () => {
  ...
  it('uses dedicated Sub2API panels for Overview and Analysis instead of old detail tables', () => {
    ...
    expect(usagePageSource).toContain('import { AccountQuotasCard, RequestEventsPanel, Sub2ApiOverviewPanel, TokenRankingCard, RankingTrendChart, ModelPricingReferenceCard } from')
  ...
  it('uses a dedicated real-data Request Health Timeline card on Overview', () => {
    ...
    expect(sub2apiOverviewPanelSource).toContain('<RequestHealthTimelineCard serviceHealth={serviceHealth} loading={!!loading} />')
    ...
    expect(requestHealthTimelineCardSource).not.toContain('usage?.service_health')
