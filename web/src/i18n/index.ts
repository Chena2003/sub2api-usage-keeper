  ...
  en: {
    translation: {
      ...
      usage_stats: {
        ...
        model_pricing_hint: 'Reference pricing per 1M tokens. Prices may vary — check provider docs for the latest rates.',
        ...
        model_pricing_col_cache_hit: 'Cache Hit',
        model_pricing_col_cache_create: 'Cache Create',
  ...
  'zh-TW': {
    translation: {
      ...
      usage_stats: {
        ...
        model_pricing_hint: '每 1M token 參考定價，實際價格以各供應商為準。',
        model_pricing_col_model: '模型',
        model_pricing_col_display_name: '顯示名稱',
        model_pricing_col_input: '輸入',
        model_pricing_col_output: '輸出',
        model_pricing_col_cache_hit: '快取命中',
        model_pricing_col_cache_create: '快取建立',
